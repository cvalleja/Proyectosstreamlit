import Proyectostreamlit as st
import pandas as pd
...
st.title("Análisis de Fraude con Tarjetas de Crédito")
...
with col2:
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["Distribuciones", "Dispersión", "Límite de Decisión", "Evaluación Modelo"])
